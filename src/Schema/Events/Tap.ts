 ...
 *
 * This schema describes events sent to Segment from [[TappedInboxMessage]]
 *
 *  @example
 *  ```
 *  {
 *    action: "tappedInboxMessage",
 *    context_module: "inboxInquiries",
 *    context_screen_owner_type: "inboxInquiries",
 *    destination_screen_owner_type: "inboxMessage",
 *    destination_screen_owner_id: "5df3e3fa485efe0012c37055",
 ...
 * ```
 */
export interface TappedInboxMessage {
  action: ActionType.tappedInboxMessage
  context_module: ContextModule.inboxInquiries
  context_screen_owner_type: OwnerType.inboxInquiries
  context_screen_owner_id?: string
  context_screen_owner_slug?: string
  destination_screen_owner_type: OwnerType.inboxMessage
  destination_screen_owner_id: string
  artwork_id: string
  partner_id: string
}
