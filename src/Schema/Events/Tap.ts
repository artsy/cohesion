 ...
 *
 * This schema describes events sent to Segment from [[tappedEditSavedSearch]]
 *
 *  @example
 *  ```
 *  {
 *    action: "tappedEditSavedSearch",
 ...
 * ```
 */
export interface TappedEditSavedSearch {
  action: ActionType.tappedEditSavedSearch
  context_screen_owner_type: ScreenOwnerType
  context_screen_owner_id?: string
  current: string
  changed: string
 ...
 *
 * This schema describes events sent to Segment from [[tappedDeleteSavedSearch]]
 *
 *  @example
 *  ```
 *  {
 *    action: "tappedDeleteSavedSearch",
 *    context_screen_owner_type: "savedSearch",
 *    context_screen_owner_id: "58de681f275b2464fcdde097",
 *  }
 * ```
 */
export interface TappedDeleteSavedSearch {
  action: ActionType.tappedDeleteSavedSearch
  context_screen_owner_type: ScreenOwnerType
  context_screen_owner_id?: string
}
