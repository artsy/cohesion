...
export enum ActionType {
  ...
  /**
   * Corresponds to {@link TappedCardsGroup}
   */
  tappedCardsGroup = "tappedCardsGroup",
  /**
   * Corresponds to {@link TappedCardsChipsGroup}
   */
  tappedCardsChipsGroup = "tappedCardsChipsGroup",
  /**
