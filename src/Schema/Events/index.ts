...
import {
  ...
  ClickedOnFrameMeasurementsDropdown,
...
export enum ActionType {
  ...
  /**
   * Corresponds to {@link ClickedOnFrameMeasurementsDropdown}
   */
   clickedOnFrameMeasurementsDropdown = "clickedOnFrameMeasurementsDropdown",
  /**
