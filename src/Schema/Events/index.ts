...
import {
  ...
  ClickedOnFrameMeasuremetsDropdown,
...
export enum ActionType {
  ...
  /**
   * Corresponds to {@link ClickedOnFrameMeasuremetsDropdown}
   */
   clickedOnFrameMeasuremetsDropdown = "clickedOnFrameMeasuremetsDropdown",
  /**
