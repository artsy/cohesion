...
export enum ContextModule {
  ...
  myCollectionArtworkAuctionResults = "myCollectionArtworkAuctionResults",
  myCollectionArtworkHeader = "myCollectionArtworkHeader",
  myCollectionArtworkMarketInsights = "myCollectionArtworkMarketInsights",
  myCollectionArtworkRelatedArticles = "myCollectionArtworkRelatedArticles",
  myCollectionArtworkSell = "myCollectionArtworkSell",
